...
/*
  This component is the Features Section of the landing page.
  Your website features are placed here in a grid layout.
  Highlight the main features of your product that your customers will value.
*/
